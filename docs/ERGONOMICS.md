...
| Typed Data decoding and validated shapes | Partial | Scalars and recursive required-field native structs decode with paths; add enums, strings, defaults, and collections |
...
- Implemented: integer, float, and boolean scalar decoders plus recursive
  ...
  and scalar fields. Decoded managed fields and path-carrying `Decode-Error`
